            ...
            <nav className="navbarNav">
                <ul className="navbarListItems">
                    <li className="navbarListItem" onClick={() => navigate('/')}>
                        <ExploreIcon fill={pathMathRoute('/') ? '#eaa40c' : '#8f8f8f'} width='36px' height='36px' />
                        <p className={pathMathRoute('/') ? 'navbarListItemNameActive' : 'navbarListItemName'}>Explore</p>
                    </li>
                    <li className="navbarListItem" onClick={() => navigate('/offers')}>
                        <OfferIcon fill={pathMathRoute('/offers') ? '#eaa40c' : '#8f8f8f'} width='36px' height='36px' />
                        <p className={pathMathRoute('/offers') ? 'navbarListItemNameActive' : 'navbarListItemName'}>Offers</p>
                    </li>
                    <li className="navbarListItem" onClick={() => navigate('/profile')}>
                        <PersonOutlineIcon fill={pathMathRoute('/profile') ? '#eaa40c' : '#8f8f8f'} width='36px' height='36px' />
